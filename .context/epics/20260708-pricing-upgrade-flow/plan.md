---
epic: 20260708-pricing-upgrade-flow
---
...
| `../../prd/billing.md` | Flip the affected "Current status" rows (upgrade flow, trials) once verified — per the [roadmap](../../roadmaps/20260711-saas-boilerplate-productization.md) maintenance rules, docs must not lead the code |
| `../../roadmaps/20260711-saas-boilerplate-productization.md` | Set E05 status → `done` after criteria 1–8 verified |
