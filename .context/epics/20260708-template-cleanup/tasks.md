---
epic: 20260708-template-cleanup
---
...
- [x] **T01 — Remove `footerNavigation` placeholder links**
...
- [x] **T02 — Remove template userMenu groups**
...
- [x] **T03 — Remove "View page source" search group**
...
- [x] **T04 — Remove decorative cookie-consent toast**
...
- [x] **T06 — Delete Customers demo page**
...
- [x] **T08 — Delete demo home, notifications slideover, and their plumbing**
...
- [x] **T05 — Delete unauthenticated mock endpoints**
...
- [x] **T09 — Prune demo-only dependencies**
...
- [x] **T10 — Ship the shell from the layer**
...
- [x] **T11 — One UserMenu, in the layer**
...
- [x] **T13 — Delete the hand-made shell; adapt the welcome page**
...
- [x] **T14 — Replace remaining `ui-avatars.com` with local initials**
...
- [x] **T15 — Rewrite `layers/uix/README.md` against reality**
...
- [x] **T16 — "Nuxt 3" → Nuxt 4 sweep in layer READMEs**
...
- [x] **T17 — Remove false `createLogger` adoption claims**
...
- [x] **T18 — Update `layers/saas/README.md` to the consolidated shell**
...
- [x] **T19 — Final acceptance sweep**
  ...
  - Update roadmap E03 status (`.context/roadmaps/20260711-saas-boilerplate-productization.md`) to done when green; note outcome in `.context/changelogs/` if warranted.
  - Depends on: T01–T18
